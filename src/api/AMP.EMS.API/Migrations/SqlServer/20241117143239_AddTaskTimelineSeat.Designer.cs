...
namespace AMP.EMS.API.Migrations.SqlServer
{
    ...
    [Migration("20241117143239_AddTaskTimelineSeat")]
    partial class AddTaskTimelineSeat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMP.EMS.API.Core.Entities.SeatGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AMP.EMS.API.Core.Entities.SeatGroupAttendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AMP.EMS.API.Core.Entities.SeatGroupAttendee", b =>
                {
                    b.HasOne("AMP.EMS.API.Core.Entities.Guest", "Guest")
                        .WithMany("SeatGroupAttendees")
                        .HasForeignKey("GuestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AMP.EMS.API.Core.Entities.SeatGroup", "SeatGroup")
                        .WithMany("SeatGroupAttendees")
            ...
            modelBuilder.Entity("AMP.EMS.API.Core.Entities.Guest", b =>
                {
                    ...
                    b.Navigation("SeatGroupAttendees");
                });
