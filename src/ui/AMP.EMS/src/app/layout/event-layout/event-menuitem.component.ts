...
export class EventMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public layoutService: LayoutService, private cd: ChangeDetectorRef, public router: Router, private menuService: EventMenuService) {
